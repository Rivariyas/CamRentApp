...
public class CamRentApp { 
 private List<CameraApp> cameraList = new ArrayList<>();
 private double walletAmount = 0.0;
 private String username = "Riva";
 private String password = "Riva_AR786";
 ...
 System.out.println("Invalid username or password. Exit the application.");
 }
 }
 ...
 switch (choice) {
 case 1:
 CamerasMenus myCamerasMenu = new CamerasMenus(cameraList);
...
myCamerasMenu.handleMyCamerasMenu(scanner);
 ...
 break;
 case 5:
 System.out.println("Thank you for using the Camera Rental App. Have a nice day!");
 System.exit(0);
 default:
 ...
 for (CameraApp camera : cameraList) {
