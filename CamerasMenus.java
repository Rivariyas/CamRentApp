...
public class CamerasMenus {
 private List<CameraApp> cameraList;
 public CamerasMenus(List<CameraApp> cameraList) {
 ...
 scanner.nextLine(); // consume newline character
 CameraApp camera = new CameraApp(brand, model, 
rentalAmount);
...
System.out.println("*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*");
 for (CameraApp camera : cameraList) {
 System.out.printf("%-13d%-14s%-16s%-22.2f%s\n",camera.getId(), camera.getBrand(), camera.getModel(), camera.getRentalAmount(), camera.isRented() ? "Rented" : "Available");
 }
